 ...
 Rectangle {
     ...
     Image {
       ...
       AppButton {
           ...
           SoundEffect{
           id:sound
           source: "./sounds/lam (online-audio-converter.com).wav"
   ...
   AppButton {
     ...
     flat: true
         ...
         onClicked: {
             var component = Qt.createComponent("letter25and26.qml")
